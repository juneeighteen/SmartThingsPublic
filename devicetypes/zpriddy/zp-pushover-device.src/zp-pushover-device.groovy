...
preferences {
  ...
  input("userKey", "text", title: "User Key", description: "Pushover User, Group, or Subscription Key")
  input("deviceName", "text", title: "Device Name", description: "Pusheover Device Name")
...
def sendTestMessage() {
  ...
  sendMessage("${testMessageText}", title: "Test Message", priority:"${testMessagePriority}" )
}


def sendMessage(message, title="", priority=0) {
